...
export const schema = yup.object().shape({
  ...
  idInsurer: yup.string().optional(),

  numsoc: yup.string().optional(),

  telefono: yup.string().required("Telefono no puede estar vacio"),
  ...
  historial: yup.string().required("La historia clinica no puede estar vacia"),
});
