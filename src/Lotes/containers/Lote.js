  ...
  return (
    <>
      <div className="content-lote">
        ...
        {lote?.urlResultado !== "" && (
          <p>
            <strong>Resultado url: </strong>
            <a target="_blank" rel="noreferrer" href={lote?.urlResultado}>
              ver resultado
            </a>{" "}
            <strong>Fecha del resultado: </strong>
            <i>{lote?.fechaResultado}</i> <strong>Realizado por: </strong>
            <i>{lote?.userResultado}</i>
          </p>
        )}
      </div>
    </>
